...
// Importowane procedury i funkcje "Grupa I5X3S1    "
extern w1ms();
extern w5mS();
extern w50mS();
...
void charInit(void)	 
{
  Lcd_WriteControl(0x40); // rybka w prawo
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x16);
  Lcd_WriteData(0x0F);
  ...
  Lcd_WriteData(0x00);
//  Lcd_WriteData(0x00);
	Lcd_WriteControl(0x48); // rybka w lewo
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x0D);
  Lcd_WriteData(0x1E);
  ...
  Lcd_WriteData(0x00);
//  Lcd_WriteData(0x00);
	Lcd_WriteControl(0x50); // rybka w gore
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x04);
  Lcd_WriteData(0x0E);
  Lcd_WriteData(0x0E);
  ...
  Lcd_WriteData(0x00);
//  Lcd_WriteData(0x00);
	Lcd_WriteControl(0x58); // rybka w dol
  Lcd_WriteData(0x00);
  Lcd_WriteData(0x0A);
  Lcd_WriteData(0x04);
  Lcd_WriteData(0x0E);
  ...
  Lcd_WriteData(0x00);
//  Lcd_WriteData(0x00);
	Lcd_WriteControl(0x60); // jedzenie	
  Lcd_WriteData(0x01);
  Lcd_WriteData(0x03);
  Lcd_WriteData(0x05);
  Lcd_WriteData(0x09);
